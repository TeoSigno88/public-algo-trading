    ...
    internal class RiskReduction
    {
        ...
        public void FirstReducerRisk()
        {
            ...
            if (strategyTestOriginale.Position.MarketPosition == MarketPosition.Long) //uso il riferimento alla strategia
            {
                ...
                if (customStop < strategyTestOriginale.Low[1] && !strategyTestOriginale.stopOrder.OrderState.Equals(OrderState.Filled))
                {
                    ...
                    strategyTestOriginale.stopOrder = strategyTestOriginale.SubmitOrderUnmanaged(0, OrderAction.Sell, OrderType.StopMarket, strategyTestOriginale.OperationQuantity, 0, customStop, "", "FirstStop");
                    ...
                    Draw.Line(strategyTestOriginale, $"firstReducerRiskLine {plotFirstStopLossCounter}", false, -1, customStop, -2, customStop, Brushes.Orange, DashStyleHelper.Dot, 2);
                    Draw.Text(strategyTestOriginale, $"firstReducerRisktext {plotFirstStopLossCounter}", $"ReducerRisk_1 {customStop}", -1, customStop - 1, Brushes.Orange);
                    plotFirstStopLossCounter++;
                }
            }
        }
